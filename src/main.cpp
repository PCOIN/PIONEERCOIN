...
uint256 hashGenesisBlock("0x0000066994e4f4d391b1b59f2cf45787bc62c0c2853749af18ce4bb9fa081096");
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "pioneercoin genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506031712;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2235921080;
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // Pioneercoin: increase each by adding 6 to bitcoin's value.
